...
#define TC74_CONFIG_STANDBY         0x80
...
{
    uint8_t data[2] = {TC74_COMMAND_RWCR, TC74_CONFIG_STANDBY};
...
{
    uint8_t data[2] = {TC74_COMMAND_RWCR, TC74_CONFIG_WAKEUP};
    return i2c_master_write_to_device(i2cPort, sensAddr, data, 2, timeOut / portTICK_PERIOD_MS);
}
...
bool tc74_is_temperature_ready(i2c_port_t i2cPort, uint8_t sensAddr, TickType_t timeOut)
{
    ...
    uint8_t config_register = TC74_COMMAND_RWCR;
...
{
    uint8_t read_command[1] = {TC74_READ_COMMAND};
